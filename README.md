...
<div style="background:#000;display:flex;justify-content:center;padding:16px 0;">
  <img src="assets/buddy-hero.png" alt="buddy logo" style="max-width: 1080px; width: 100%; height: auto;" />
</div>
